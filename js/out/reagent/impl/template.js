...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__19059__auto__,writer__19060__auto__,opt__19061__auto__){
return cljs.core._write.call(null,writer__19060__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__18453__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__18453__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__18453__auto__)){
return or__18453__auto__;
} else {
...
var G__19955 = o;
(G__19955[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
while (G__19957__i < G__19957__a.length) {G__19957__a[G__19957__i] = arguments[G__19957__i + 0]; ++G__19957__i;}
  args = new cljs.core.IndexedSeq(G__19957__a,0);
} 
...
var old_19959 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_19959))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_19959)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__18441__auto__ = (node === document.activeElement);
if(and__18441__auto__){
var and__18441__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
...
if(cljs.core.truth_((function (){var and__18441__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__19962 = jsprops;
(G__19962["defaultValue"] = value);

(G__19962["onChange"] = ((function (G__19962,v,value,on_change){
return (function (p1__19960_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__19960_SHARP_);
});})(G__19962,v,value,on_change))
);
...
var temp__4659__auto__ = (function (){var G__19968 = cljs.core.meta.call(null,v);
if((G__19968 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__19968);
}
})();
if((temp__4659__auto__ == null)){
...
var jsprops = {"argv": v};
var G__19970_19971 = v;
var G__19970_19972__$1 = (((G__19970_19971 == null))?null:reagent.impl.template.key_from_vec.call(null,G__19970_19971));
if((G__19970_19972__$1 == null)){
} else {
(jsprops["key"] = G__19970_19972__$1);
}
...
var p = (function (){var temp__4659__auto__ = (function (){var G__19975 = cljs.core.meta.call(null,argv);
if((G__19975 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__19975);
}
})();
if((temp__4659__auto__ == null)){
return jsprops;
...
var G__19976 = (((jsprops == null))?{}:jsprops);
(G__19976["key"] = key);
...
var G__19977 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__19977;
continue;
}
} else {
...
var n__19368__auto___19978 = a.length;
var i_19979 = (0);
while(true){
if((i_19979 < n__19368__auto___19978)){
(a[i_19979] = reagent.impl.template.as_element.call(null,(a[i_19979])));

var G__19980 = (i_19979 + (1));
i_19979 = G__19980;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__19368__auto___19981 = a.length;
var i_19982 = (0);
while(true){
if((i_19982 < n__19368__auto___19981)){
var val_19983 = (a[i_19982]);
if((cljs.core.vector_QMARK_.call(null,val_19983)) && ((reagent.impl.template.key_from_vec.call(null,val_19983) == null))){
(o["no-key"] = true);
} else {
}

(a[i_19982] = reagent.impl.template.as_element.call(null,val_19983));

var G__19984 = (i_19982 + (1));
i_19982 = G__19984;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__18441__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__18441__auto__){
return (ctx["no-key"]);
} else {
return and__18441__auto__;
...
var G__19986 = (cljs.core.count.call(null,argv) - first_child);
switch (G__19986) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__19986){
