...
var or__18453__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__18453__auto__)){
return or__18453__auto__;
} else {
var or__18453__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__18453__auto____$1)){
return or__18453__auto____$1;
} else {
var or__18453__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__18453__auto____$2)){
return or__18453__auto____$2;
} else {
var or__18453__auto____$3 = (w["msRequestAnimationFrame"]);
if(cljs.core.truth_(or__18453__auto____$3)){
return or__18453__auto____$3;
} else {
...
var n__19368__auto__ = a.length;
var i = (0);
while(true){
if((i < n__19368__auto__)){
var c_19891 = (a[i]);
if(cljs.core.truth_((c_19891["cljsIsDirty"]))){
(c_19891["forceUpdate"])();
} else {
}
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__19059__auto__,writer__19060__auto__,opt__19061__auto__){
return cljs.core._write.call(null,writer__19060__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__19895 = c;
var G__19895__$1 = (((G__19895 == null))?null:(G__19895["props"]));
if((G__19895__$1 == null)){
return null;
} else {
return (G__19895__$1["argv"]);
}
});
...
var G__19897_19898 = (c["cljsRatom"]);
if((G__19897_19898 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__19897_19898);
}
