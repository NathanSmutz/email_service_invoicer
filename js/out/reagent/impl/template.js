...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__7013__auto__,writer__7014__auto__,opt__7015__auto__){
return cljs.core._write(writer__7014__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__6407__auto__ = reagent.impl.template.named_QMARK_(x);
...
var or__6407__auto__ = reagent.impl.template.hiccup_tag_QMARK_(x);
if(cljs.core.truth_(or__6407__auto__)){
return or__6407__auto__;
} else {
...
var G__12660 = o;
(G__12660[reagent.impl.template.cached_prop_name(k)] = reagent$impl$template$convert_prop_value(v));
...
var old_12664 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_(old_12664))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_12664)].join(''):class$));
} else {
}
...
if(cljs.core.not((function (){var and__6395__auto__ = (node === document.activeElement);
if(and__6395__auto__){
var and__6395__auto____$1 = reagent.impl.template.has_selection_api_QMARK_((node["type"]));
if(cljs.core.truth_(and__6395__auto____$1)){
...
if(cljs.core.truth_((function (){var and__6395__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__12667 = jsprops;
(G__12667["defaultValue"] = value);

(G__12667["onChange"] = ((function (G__12667,v,value,on_change){
return (function (p1__12665_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__12665_SHARP_);
});})(G__12667,v,value,on_change))
);
...
var vec__12671 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12671,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12671,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12671,(2),null);
...
var temp__4659__auto__ = (function (){var G__12677 = cljs.core.meta(v);
if((G__12677 == null)){
return null;
} else {
return reagent.impl.template.get_key(G__12677);
}
})();
if((temp__4659__auto__ == null)){
...
var jsprops = ({"argv": v});
var G__12679_12680 = v;
var G__12679_12681__$1 = (((G__12679_12680 == null))?null:reagent.impl.template.key_from_vec(G__12679_12680));
if((G__12679_12681__$1 == null)){
} else {
(jsprops["key"] = G__12679_12681__$1);
}
...
var G__12685 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__12685) : reagent.impl.template.as_element.call(null,G__12685));
} else {
var p = (function (){var temp__4659__auto__ = (function (){var G__12686 = cljs.core.meta(argv);
if((G__12686 == null)){
return null;
} else {
return reagent.impl.template.get_key(G__12686);
}
})();
if((temp__4659__auto__ == null)){
return jsprops;
...
var G__12687 = (((jsprops == null))?({}):jsprops);
(G__12687["key"] = key);
...
var G__12688 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__12688;
continue;
}
} else {
...
var n__7322__auto___12689 = a.length;
var i_12690 = (0);
while(true){
if((i_12690 < n__7322__auto___12689)){
(a[i_12690] = reagent.impl.template.as_element((a[i_12690])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7322__auto___12692 = a.length;
var i_12693 = (0);
while(true){
if((i_12693 < n__7322__auto___12692)){
var val_12694 = (a[i_12693]);
if((cljs.core.vector_QMARK_(val_12694)) && ((reagent.impl.template.key_from_vec(val_12694) == null))){
(o["no-key"] = true);
} else {
}

(a[i_12693] = reagent.impl.template.as_element(val_12694));
...
if(cljs.core.truth_((function (){var and__6395__auto__ = cljs.core.not(reagent.impl.component._STAR_non_reactive_STAR_);
if(and__6395__auto__){
return (ctx["no-key"]);
} else {
return and__6395__auto__;
...
var G__12697 = (cljs.core.count(argv) - first_child);
switch (G__12697) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__12697){
